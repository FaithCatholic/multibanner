...
namespace Drupal\multibanner\Plugin\video_embed_field\Provider;

use Drupal\video_embed_field\ProviderPluginBase;

/**
 * A YouTube (minimal) provider plugin.
 *
 * @VideoEmbedProvider(
 *   id = "youtube_minimal",
 *   title = @Translation("YouTube Minimal")
 * )
 */
class YouTubeMinimal extends ProviderPluginBase {
