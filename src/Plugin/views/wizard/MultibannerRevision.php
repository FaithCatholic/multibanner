...
/**
 * Tests creating multibanner revision views with the wizard.
 *
 * @ViewsWizard(
 *   id = "multibanner_revision",
 *   base_table = "multibanner_field_revision",
 *   title = @Translation("Multibanner revisions")
 * )
 */
class MultibannerRevision extends WizardPluginBase {
  ...
  protected $filters = [
    'status' => [
      'value' => TRUE,
      'table' => 'multibanner_field_revision',
      'field' => 'status',
      'plugin_id' => 'boolean',
  ...
  protected function defaultDisplayOptions() {
    ...
    /* Field: Multibanner revision: Created date */
    $display_options['fields']['changed']['id'] = 'changed';
    $display_options['fields']['changed']['table'] = 'multibanner_field_revision';
    $display_options['fields']['changed']['field'] = 'changed';
    $display_options['fields']['changed']['entity_type'] = 'multibanner';
    ...
    /* Field: Multibanner revision: Name */
    $display_options['fields']['name']['id'] = 'name';
    $display_options['fields']['name']['table'] = 'multibanner_field_revision';
