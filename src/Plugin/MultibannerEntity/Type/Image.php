 ...
 * )
 */
class Image extends MultibannerTypeBase {
   ...
   *   multibanner entity config object.
   */
  ...
  public function getField(MultibannerInterface $multibanner, $name) {
    ...
    $file = $multibanner->{$source_field}->entity;
  ...
  public function buildConfigurationForm(array $form, FormStateInterface $form_state) {
    ...
    $form['source_field'] = [
      ...
      '#description' => $this->t('Field on multibanner entity that stores Image file. You can create a bundle without selecting a value for this dropdown initially. This dropdown can be populated after adding fields to the bundle.'),
  ...
  public function thumbnail(MultibannerInterface $multibanner) {
    ...
    /** @var \Drupal\file\FileInterface $file */
    if ($file = $multibanner->{$source_field}->entity) {
  ...
  public function getDefaultName(MultibannerInterface $multibanner) {
    ...
    /** @var \Drupal\file\FileInterface $file */
    if (!empty($source_field) && ($file = $multibanner->{$source_field}->entity)) {
      return $file->getFilename();
    }

    return parent::getDefaultName($multibanner);
  }
