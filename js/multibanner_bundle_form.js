/**
 * @file
 * Javascript for the multibanner bundle form.
 */
...
(function ($, Drupal) {
  ...
  /**
   * Behaviors for setting summaries on multibanner bundle form.
   *
   * @type {Drupal~behavior}
   *
   * @prop {Drupal~behaviorAttach} attach
   *   Attaches summary behaviors on multibanner bundle edit forms.
   */
